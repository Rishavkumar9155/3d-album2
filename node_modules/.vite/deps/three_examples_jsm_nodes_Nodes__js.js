...
var IndexNode = class extends Node_default {
  constructor(scope) {
    super("uint");
    this.scope = scope;
...
var UniformsNode = class extends BufferNode_default {
  ...
  setup(builder) {
    ...
    if (this._elementType.charAt(0) === "i")
      arrayType = Int32Array;
    else if (this._elementType.charAt(0) === "u")
...
var ViewportNode = class extends Node_default {
  ...
  getNodeType() {
    if (this.scope === ViewportNode.VIEWPORT)
      return "vec4";
    else if (this.scope === ViewportNode.COORDINATE)
      return "vec3";
    else
      return "vec2";
  }
...
var ViewportDepthNode = class extends Node_default {
...
var ClippingNode = class extends Node_default {
...
var NodeBuilder = class {
  ...
  getCacheFromNode(node, parent2 = true) {
    ...
    if (data.cache === void 0)
      data.cache = new NodeCache_default(parent2 ? this.getCache() : null);
    return data.cache;
  }
  isAvailable() {
    return false;
...
var SceneNode = class extends Node_default {
...
var PassNode = class extends TempNode_default {
